const translations = {
  zh: {
    ...
    projectLabelOne: "HTML 项目 · 作品",
    projectTitleOne: "制作AI术语 HTML",
    projectBodyOne: "一个用于整理和展示 AI 基础术语的 HTML 项目，帮助初学者更轻松地理解常见概念。",
    projectStatusOne: "已收录到作品集",
  ...
  en: {
    ...
    projectLabelOne: "HTML project · Work",
    projectTitleOne: "AI Terminology HTML",
    projectBodyOne: "An HTML project for organizing and presenting foundational AI terms, making common concepts easier for beginners to understand.",
    projectStatusOne: "Added to portfolio",
