const translations = {
  zh: {
    ...
    projectLabelFive: "单机小游戏 · 05",
    projectTitleFive: "桌面清压台",
    projectBodyFive: "适合工作间隙放松的一分钟小游戏，支持单人清压和双人同屏对战。",
    openProject: "打开作品",
    comingSoon: "内容即将更新",
    contactEyebrow: "保持联系",
  ...
  en: {
    ...
    projectLabelFive: "Solo Mini Game · 05",
    projectTitleFive: "Desk Calm Station",
    projectBodyFive: "A one-minute break game for workday downtime, with solo clearing and two-player same-screen play.",
